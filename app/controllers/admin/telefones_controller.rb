    ...
    respond_to do |format|
      if @telefone.save
        if @telefone.telefonavel_type == 'Usuario'
          format.html { redirect_to [:admin, Usuario.find(@telefone.telefonavel_id)], :notice => 'Exemplo was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
        if @telefonavel_type == 'Usuario'
          format.html { redirect_to [:admin, Usuario.find(@telefonavel_id)], :notice => 'Exemplo was successfully updated.' }
          format.json { head :ok }
        else
